...
export default function HomePage() {
  ...
  if (loading) {
    return (
      <main className="mx-auto flex min-h-screen max-w-4xl items-center justify-center bg-gradient-to-br from-white via-cyan-50/30 to-teal-50/30 px-4 py-10 text-slate-600">
        読み込み中...
      </main>
    );
  }
  ...
  if (!user) {
    return (
      <main className="container mx-auto flex min-h-screen flex-col gap-10 bg-gradient-to-br from-white via-cyan-50/30 to-teal-50/30 px-4 py-10">
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-4xl flex-col gap-6 bg-gradient-to-br from-white via-cyan-50/30 to-teal-50/30 px-4 py-10">
